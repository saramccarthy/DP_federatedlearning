...
from cifar10NN import cifar10, cifar10_eval
...
parser.add_argument('--train_dir', type=str, default='./models/cifar/client',
...
class cifar10_client(object):
    ...
    def eval(self):
        ...
        cifar10_eval.evaluate(True, "./models/cifar/eval/central", self.model_dir, self.client)

    def modelDir(self, train_dir, client):
        model_dir = ""+train_dir+str(client)
      ...
      with tf.Graph().as_default():   
        ...
        with tf.train.MonitoredTrainingSession(
            ...
            while not mon_sess.should_stop():
                ...
                #saver = tf.train.Saver()
                #save_path = saver.save(mon_sess, "/Users/Sara/Dropbox/Class/NN/Project/models/cifar/tfmodel.ckpt")
