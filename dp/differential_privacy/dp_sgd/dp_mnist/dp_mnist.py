...
tf.flags.DEFINE_integer("projection_dimensions", 0,# 60,
...
tf.flags.DEFINE_string("training_data_path",
                       "data/mnist_data/mnist_train.tfrecord",
                       "Location of the training data.")
tf.flags.DEFINE_string("eval_data_path",
                       "data/mnist_data/mnist_test.tfrecord",
...
tf.flags.DEFINE_string("save_path", "data/mnist_data/save_folder",
    ...
    if network_parameters.projection_type == "PCA":
      with tf.variable_scope("pca"):
        ...
        pca_projection = dp_pca.ComputeDPPrincipalProjection(
            ...
            gaussian_sanitizer, [0, 0], pca_sigma)
